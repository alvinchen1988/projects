...
<main>
	<h1>Students</h1>
	<input type="text" id="quick-search" placeholder="Type a name" name="search"></input>
	<?php
	...
	<?php
		...
		echo "<table class='student-table'><thead><tr><th id='segment1' colspan ='2'>$alphabetOne - $alphabetTwo</th></tr></thead>";
